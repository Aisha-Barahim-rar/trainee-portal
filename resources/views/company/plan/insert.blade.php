...
<form method="POST" action="{{ route('company.plan.store',$user->ID) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="grid gap-6 mt-6">
                            ...
                            <!-- plan -->
                            <div class="space-y-2">
                                <x-form.label for="plan" :value="__('Plan')" />
   ...
   id="plan" type="file" name="plan" value="old('plan')" required placeholder="{{ __('Plan') }}" />
