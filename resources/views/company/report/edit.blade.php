        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('company.report.update', $report->ID) }}"
                        ...
                        <div class="grid gap-6 mt-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <input
                                    ...
                                    id="report" type="file" name="report" value="old('report')"
                                    required placeholder="{{ __('Report') }}" />
                                <a href="/reports/{{ $user->ID }}/{{ $report->file }}" class="text-sm text-gray-600"
                                    download>{{ $report->file }}</a>
                                <input type="hidden" value="{{ $report->file }}" name="oldFile" />
