...
<form method="POST" action="{{ route('company.evaluation.store',$user->ID) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="grid gap-6 mt-6">
                            ...
                            <!-- evaluation -->
                            <div class="space-y-2">
                                <x-form.label for="evaluation" :value="__('Evaluation')" />
   ...
   id="evaluation" type="file" name="evaluation" value="old('evaluation')" required placeholder="{{ __('Evaluation') }}" />
