                            ...
                            <li class="flex justify-between gap-x-6 py-5 mb-4">
                                ...
                                <div class="sm:flex-col sm:items-end">
                                    ...
                                    <div class="inline-flex rounded-md shadow-sm" role="group">
                                        ...
                                        <x-button variant="secondary" href="{{ route('admin.company.edit',$company_mentor->ID) }}" 
                                            :squared=true class="border-t border-b border-r">
                                            <x-heroicon-o-pencil-alt class="flex-shrink-0 w-6 h-6" aria-hidden="true" />
                                        </x-button>
                                        <x-button variant="secondary" size="sm" x-data=""
        ...
        <x-modal name="confirm-company-trainee-add-{{ $company_mentor->ID }}" :show="$errors->userDeletion->isNotEmpty()" focusable>
            <form method="post" action="{{ route('admin.company.add_trainees', $company_mentor->ID) }}" class="p-6">
                ...
                <h2 class="text-lg font-medium mb-4">
                    {{ __('Please select from trainees list to be mentored by') }} {{ $company_mentor->name }}
                </h2>
